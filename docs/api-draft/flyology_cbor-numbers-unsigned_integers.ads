...
package Flyology_CBOR.Numbers.Unsigned_Integers is
   type Conversion_Status is (Converted, Negative_Value, Above_Range);
...
private
   type Conversion_Result is record
      Status_Value : Conversion_Status := Negative_Value;
